...
TCHAR szClassName[] = _T ("Laboratory work number 2!!!");
...
int WINAPI WinMain (HINSTANCE hThisInstance, HINSTANCE hPrevInstance, LPSTR lpszArgument, int nCmdShow) {
    ...
    wincl.hbrBackground = (HBRUSH) CreateSolidBrush (RGB (0, 0, 255));
...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    static int cxCoord;
    static int cyCoord;
    static HBRUSH editBrush = (HBRUSH) CreateSolidBrush (RGB (255, 0, 0));
    ...
    switch (message) {
        case WM_CREATE: {
            ...
            addButton = CreateWindow (TEXT ("BUTTON"), TEXT ("Add Text"),
        ...
        case WM_COMMAND: {
            switch (LOWORD (wParam)) {
                ...
                case ID_ABOUT:{
                    MessageBox(hwnd, "Created by Dumitru Chetrusca", "XD", MB_OK | MB_ICONINFORMATION);
                    break;
                }
            }
            break;
